...
public class ChromeAutomationService extends Service {
    private static final int TOTAL_REQUESTS = 100;
    private static final int DELAY_BETWEEN_REQUESTS = 5000; // 5 sec delay between openings
