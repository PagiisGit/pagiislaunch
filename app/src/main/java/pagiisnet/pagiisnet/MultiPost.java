...
public class MultiPost extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Sirroco upload");
        ...
        mButtonUpload.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    Toast.makeText(MultiPost.this, "Sirocco-Image upload in progress !!", Toast.LENGTH_SHORT).show();
                }else
                {
        ...
        viewUploads.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(MultiPost.this, "Sirocco-Music upload in progress !!", Toast.LENGTH_SHORT).show();
                }else
                {
                    mProgressBar.setVisibility(View.VISIBLE);
                    musicUpload();
        ...
        viewUploadsHeadlines.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(MultiPost.this, "SiroccoHeadlines upload in progress !!", Toast.LENGTH_SHORT).show();
                }else
                {
                    mProgressBar.setVisibility(View.VISIBLE);
                    headlinesUpload();
    ...
    private void uploadNotifications()
    {
        if(mImageUri != null) {
            ...
            Toast.makeText(MultiPost.this, "PAGiiS Music uploading ...", Toast.LENGTH_SHORT).show();
            ...
            mStorageRef = FirebaseStorage.getInstance().getReference("PagiisNotifications");
            ...
            mUploadTask = fileReference.putFile(mImageUri)
                            ...
                            fileReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>()
                            {
                                ...
                                public void onSuccess(Uri uri)
                                {
                                    ...
                                    SirrocoImageUploads upload = new SirrocoImageUploads(mEditTextFileName.getText().toString().trim(),
                                            finalImageUrl,saveRaterBarValue,currentUserId,mEditTextFileModel.getText().toString().trim());
                                    ...
                                    mDatabaseRef
                                            ...
                                            .setValue(upload, new DatabaseReference.CompletionListener()
                                            {
                                                ...
                                                public void onComplete(DatabaseError databaseError,
                                                    ...
                                                    Toast.makeText(MultiPost.this, "PAGiiS music upload successful !!", Toast.LENGTH_SHORT).show();
                                                    mProgressBar.setVisibility(View.INVISIBLE);
                                                    Intent intent = new Intent(MultiPost.this,MemePage.class);
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(MultiPost.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
    ...
    private void checkifAdmindTrue() {
        ...
        mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                ...
                {
                    Intent intent = new Intent(MultiPost.this, MapsActivity.class);
    ...
    private void musicUpload()
    {
        ...
        if (mImageUri != null) {
            ...
            Toast.makeText(MultiPost.this, "PAGiiS notification uploading ...", Toast.LENGTH_SHORT).show();
    ...
    private void headlinesUpload()
    {
        ...
        if (mImageUri != null)
        {
            Toast.makeText(MultiPost.this, "PAGiiS Headlines uploading ...", Toast.LENGTH_SHORT).show();
            ...
            mStorageRef = FirebaseStorage.getInstance().getReference("SiroccoUploadHeadlines");
                                    ...
                                    nDatabaseRef
                                            ...
                                            .setValue(upload, new DatabaseReference.CompletionListener()
                                            {
                                                ...
                                                public void onComplete(DatabaseError databaseError,
                                                    ...
                                                    //mProgressCircle.setVisibility(View.INVISIBLE);  This function is used to hide the progress Bar after its function is done
                                                    Toast.makeText(MultiPost.this, "PAGiiS Headlines upload successful !!", Toast.LENGTH_SHORT).show();
                                                    mProgressBar.setVisibility(View.INVISIBLE);
                                                    Intent intent = new Intent(MultiPost.this,MemePage.class);
                                                    startActivity(intent);
                                                    // String uniqueKey = databaseReference.getKey();
    ...
    private void Upload()
    {
        ...
        if (mImageUri != null) {
            ...
            Toast.makeText(MultiPost.this, "PAGiiS image uploading ...", Toast.LENGTH_SHORT).show();
                                    ...
                                    mDatabaseRef
                                            ...
                                            .setValue(upload, new DatabaseReference.CompletionListener()
                                            {
                                                ...
                                                public void onComplete(DatabaseError databaseError,
                                                    ...
                                                    //mProgressCircle.setVisibility(View.INVISIBLE);  This function is used to hide the progress Bar after its function is done
                                                    Toast.makeText(MultiPost.this, "PAGiiS image upload successful !!", Toast.LENGTH_SHORT).show();
                                                    mProgressBar.setVisibility(View.INVISIBLE);
                                                    Intent intent = new Intent(MultiPost.this,MemePage.class);
                                                    startActivity(intent);
                                                    // String uniqueKey = databaseReference.getKey();
