...
public class Music extends AppCompatActivity implements ViewMusicAdaptor.OnItemClickListener, MapsProfileAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            mAuth.signOut();
            Intent intent = new Intent(Music.this, LoginActivity.class);
        ...
        mAdapter = new ViewMusicAdaptor(Music.this,mUploads);

        mapsAdapter = new MapsProfileAdapter(Music.this,mapsUploads);


        mAdapter.setOnItemClickListener(Music.this);

        mapsAdapter.setOnItemClickListener(Music.this);
        ...
        musicReplacement = findViewById(R.id.musicId);
        ...
        gotoMusic.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent = new Intent(Music.this, SiroccoMusicActivity.class);
                startActivity(intent);
                finish();
    ...
    private void getOnlineHeadline()
    {
        ...
        mDataBaseListener = mDatabaseRef.orderByChild("exRating").equalTo("Music").addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(Music.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                mProgressCircle.setVisibility(View.INVISIBLE);
            }
        });
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        if (requestCode == MY_PERMISSIONS_REQUEST_READ_EXTERNAL_STORAGE) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(Music.this, "GET_ACCOUNTS Denied",
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            Intent intent = new Intent(Music.this, ActivityUploadImage.class);
    ...
    public void onItemClick(int position) {
        ...
        if (!imageUrl.isEmpty()) {
            ...
            {
                Intent intent = new Intent(Music.this, LinkView.class);
