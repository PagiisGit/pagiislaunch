...
public class CreateEvent extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        actionBar.setTitle("@Sirocco_ #LIve_EvenT");
        ...
        mDatabaseRef_x = FirebaseDatabase.getInstance().getReference().child("LiveEventsAdmins");
    ...
    private void myLastLocationDetailsMetod()
    {
        ...
        locationDetails.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError)
            {
                ...
                Toast.makeText(CreateEvent.this, "last location not found"+"Results"+":"+e, Toast.LENGTH_SHORT).show();
                finish();
    ...
    private void opneOnlineShop()
    {
        if (mImageUri != null && shopType != null && mUploadTask ==null) {
            ...
            final String raterBarValueDefault = "EventRipple";

            final String currentUserId = mAut.getCurrentUser().getUid();

            myUserId = currentUserId;

            mDatabaseRef_x = FirebaseDatabase.getInstance().getReference().child("LiveEventsExtraInfor");
            ...
            Toast.makeText(CreateEvent.this, "PAGiiS Live event loading ...", Toast.LENGTH_SHORT).show();
            ...
            mDatabaseRef = FirebaseDatabase.getInstance().getReference("PagiisLiveEvents");

            mStorageRef = FirebaseStorage.getInstance().getReference("PagiisLiveEvents");
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            fileReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    final createEventFile upload = new createEventFile(shopName.getText().toString().trim(), finalImageUrl,shopType, currentUserId,shopEmail.getText().toString().trim() , shopCell.getText().toString().trim(), shopBankDetails.getText().toString().trim(),"Welcome to our LIve Event tank you for te visit","1","1","1","1","1",myLastLocationDetails,MyProfileUrl,MyName,"live");
                                    ...
                                    mDatabaseRef.push()
                                            .setValue(upload, new DatabaseReference.CompletionListener() {
                                                ...
                                                public void onComplete(DatabaseError databaseError,
                                                    ...
                                                    storeVisitKey = databaseReference.getKey();

                                                    //mProgressCircle.setVisibility(View.INVISIBLE);  This function is used to hide the progress Bar after its function is done
                                                    Toast.makeText(CreateEvent.this, "PAGiiS event opened successful !!", Toast.LENGTH_SHORT).show();

                                                    mProgressBar.setVisibility(View.INVISIBLE);
                                                    Intent intent = new Intent(CreateEvent.this, EventPreviewEdit.class);
                                                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                                    intent.putExtra("visit_user_id",storeVisitKey);
                                                    intent.putExtra("invite_id",myUserId);
        ...
        {
            Toast.makeText(this, "Please Attach Event Profile Picture /Event  Category to succesfully open event.", Toast.LENGTH_LONG).show();
        }
    }
}
