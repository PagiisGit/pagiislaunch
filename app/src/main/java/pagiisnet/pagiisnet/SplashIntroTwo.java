...
public class SplashIntroTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_splash_intro_two);
        ...
        skipOne.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                Intent registerIntent = new Intent(SplashIntroTwo.this, SplashIntroThree.class);
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run()
            {
                ...
                }else
                {
                    ...
                    Intent registerIntent = new Intent(SplashIntroTwo.this, MapsActivity.class);
                    registerIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    startActivity(registerIntent);
                    finish();
