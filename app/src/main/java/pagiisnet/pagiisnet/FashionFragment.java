 ...
 */
public class FashionFragment extends Fragment implements ViewStoreCatergoryAdaptor.OnItemClickListener, MapsProfileAdapter.OnItemClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter.setOnItemClickListener(FashionFragment.this);

        mapsAdapter.setOnItemClickListener(FashionFragment.this);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fashionReplacement = rootView.findViewById(R.id.fashionId);
