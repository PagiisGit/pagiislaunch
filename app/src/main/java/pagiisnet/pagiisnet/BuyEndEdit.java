...
public class BuyEndEdit extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buy_end_edit);
        ...
        mButtonUpload.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    Toast.makeText(BuyEndEdit.this, "PAGiiS event loading!!", Toast.LENGTH_SHORT).show();
                ...
                }else
                {
                    ...
                    mDatabaseRef.child(on_maps_visited_user_id).addValueEventListener(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot)
                        {
                            ...
                            {
                                Toast.makeText(BuyEndEdit.this, "Event status upload-max reached !!"+"\n"+"Please delete some of your posts and repost", Toast.LENGTH_LONG).show();
                            }
                        }
                        @Override
                        public void onCancelled(@NonNull DatabaseError databaseError)
                        {
                            Toast.makeText(BuyEndEdit.this, "upload canclled !", Toast.LENGTH_SHORT).show();
                            finish();
       ...
       /* viewUploads.setOnClickListener(new View.OnClickListener()
        ...
        contentRater.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                Toast.makeText(BuyEndEdit.this, " Pagiis live events  ", Toast.LENGTH_SHORT).show();
            }
        });
    }
...

    {
        ...
        mDatabaseRef_y = FirebaseDatabase.getInstance().getReference("PagiisLiveEvents").child(eventVisitedId);
    ...
    private void checkifAdmindTrue()
    {
        ...
        mDatabaseRef_x = FirebaseDatabase.getInstance().getReference().child("PagiisLiveEvents").child("storeAdminId");
        ...
        mDatabaseRef_x.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError)
            {
                ...
                Toast.makeText(BuyEndEdit.this,databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
    ...
    private void Upload() {
        if (mImageUri != null && !mEditTextFileName.getText().toString().isEmpty())
        {
            ...
            Toast.makeText(BuyEndEdit.this, "PAGiiS image uploading ...", Toast.LENGTH_SHORT).show();
                            ...
                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
...

                                {
                                    ...
                                    public void onSuccess(Uri uri)
                                    {
                                        ...
                                        mDatabaseRef.child(eventVisitedId)
                                                .push()
                                                .setValue(upload, new DatabaseReference.CompletionListener()
                                                {
                                                    ...
                                                    public void onComplete(DatabaseError databaseError,
                                                        ...
                                                        Toast.makeText(BuyEndEdit.this, "PAGiiS event ready !!", Toast.LENGTH_SHORT).show();

                                                        final String uploadId = databaseReference.getKey();


                                                        mDatabaseRef_y.child("welcomeNote").setValue(welcomeNoneFinal).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                            @Override
                            ...
                            public void onComplete(DatabaseError databaseError,
                                ...
                                mDatabaseEventAttendance.child(on_maps_visited_user_id).child(userIdRef).child("admin").setValue("true").addOnCompleteListener(new OnCompleteListener<Void>() {
...

                                    {
                                        ...
                                        //mProgressCircle.setVisibility(View.INVISIBLE);  This function is used to hide the progress Bar after its function is done
                                        Toast.makeText(BuyEndEdit.this, "event rippled succefully. !!", Toast.LENGTH_SHORT).show();


                                        mProgressBar.setVisibility(View.INVISIBLE);
                                        Intent intent = new Intent(BuyEndEdit.this, ViewEvent.class);
                                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                        startActivity(intent);
                                        // String uniqueKey = databaseReference.getKey();
                                        //Create the function for Clearing/The ImageView Widget.
