...
public class videoUpload {
    ...
    public videoUpload(String name, String imageUrl, String rateEx, String userId,String myName,String timePost,String postLocation,String likes,String views,String s) {
        if (name.trim().equals(""))
        {
            name = "No Name";
        }
