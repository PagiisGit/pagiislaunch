...
public class Business extends AppCompatActivity implements ViewStoreCatergoryAdaptor.OnItemClickListener,MapsProfileAdapter.OnItemClickListener{
    ...
    private ImageView businessReplacement;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            mAuth.signOut();
            Intent intent = new Intent(Business.this, LoginActivity.class);
        ...
        actionBar.setTitle("@sir_occo #business");
        ...
        mAdapter = new ViewStoreCatergoryAdaptor(Business.this,mUploads);

        mapsAdapter = new MapsProfileAdapter(Business.this,mapsUploads);


        mAdapter.setOnItemClickListener(Business.this);

        mapsAdapter.setOnItemClickListener(Business.this);
        ...
        businessReplacement = findViewById(R.id.businessId);

        businessReplacement.setVisibility(View.VISIBLE);
        ...
        gotoMusic.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent = new Intent(Business.this, SiroccoMusicActivity.class);
                startActivity(intent);
                finish();
    ...
    private void getOnlineHeadline()
    {
        ...
        mDataBaseListener = mDatabaseRef.orderByChild("exRating").equalTo("Business").addValueEventListener(new ValueEventListener() {
            @Override
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(Business.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                mProgressCircle.setVisibility(View.INVISIBLE);
            }
        });
    ...
    {
        mDBlistener = nDatabaseRef.orderByChild("exRating").equalTo("Business").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                ...
                if(dataSnapshot.exists())
                {
                    ...
                    businessReplacement.setVisibility(View.INVISIBLE);
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        if (requestCode == MY_PERMISSIONS_REQUEST_READ_EXTERNAL_STORAGE) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(Business.this, "GET_ACCOUNTS Denied",
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            Intent intent = new Intent(Business.this, ActivityUploadImage.class);
    ...
    public void onItemClick(int position) {
        ...
        if (!imageUrl.isEmpty()) {
            ...
            {
                Intent intent = new Intent(Business.this, LinkView.class);
