...
public class ViewStreamsAdaptor extends RecyclerView.Adapter<ViewStreamsAdaptor.VideoViewHolder>
{
    ...
    private ViewStreamsAdaptor.OnItemClickListener mListener;

    private ProgressBar mProgressBar;

    public ViewStreamsAdaptor(Context context, List<ImageUploads> uploads)
    {
        mContext = context;
        mUploads = uploads;
    }
    @Override
    public ViewStreamsAdaptor.VideoViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        View v = LayoutInflater.from(mContext).inflate(R.layout.video_view_item_two, parent, false);
        return new ViewStreamsAdaptor.VideoViewHolder(v);
    }
    @Override
    public void onBindViewHolder(final ViewStreamsAdaptor.VideoViewHolder holder, final int position)
    {
    ...
    public void setOnItemClickListener(ViewStreamsAdaptor.OnItemClickListener listener)
    {
