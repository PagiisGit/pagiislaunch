...
public class viewServiceCategory extends RecyclerView.Adapter<viewServiceCategory.ImageViewHolder> {
    ...
    private viewServiceCategory.OnItemClickListener mListener;

    // private  List<String> linIconsView;

    public viewServiceCategory(Context context, List<ImageUploads> uploads)
    {
        mContext = context;
        mUploads = uploads;
    ...
    @Override
    public viewServiceCategory.ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.profile_service_item_selector, parent, false);
        return new viewServiceCategory.ImageViewHolder(v);

    }

    @Override
    public void onBindViewHolder(viewServiceCategory.ImageViewHolder holder, @SuppressLint("RecyclerView") final int position) {
...
// Now, you can also use a ViewTreeObserver to ensure the ImageView is actually visible on the screen
    ...
    public void setOnItemClickListener(viewServiceCategory.OnItemClickListener listener)
    {
