...
public class MapsProfileAdapter extends RecyclerView.Adapter<MapsProfileAdapter.ImageViewHolder>{
    ...
    public MapsProfileAdapter(Context context, List<ImageUploads> uploads) {
        mContext = context;
        mUploads = uploads;
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new MapsProfileAdapter.ImageViewHolder(v);
    ...
    public void onBindViewHolder(ImageViewHolder holder, final int position) {
        ...
        if(loadImageUrl.compareTo("null") !=0)
        {
           ...
           // holder.profileImageView.setImageDrawable(ContextCompat.getDrawable(mContext,R.drawable.ic_sirocco_icon));
