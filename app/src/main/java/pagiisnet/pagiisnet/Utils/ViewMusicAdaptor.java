...
public class ViewMusicAdaptor extends RecyclerView.Adapter<ViewMusicAdaptor.ImageViewHolder>
{
    ...
    private ViewMusicAdaptor.OnItemClickListener mListener;

    // private  List<String> linIconsView;


    public ViewMusicAdaptor(Context context, List<SirrocoImageUploads> uploads) {
        mContext = context;
        mUploads = uploads;
    ...
    @Override
    public ViewMusicAdaptor.ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.maps_view_cart_item, parent, false);
        return new ViewMusicAdaptor.ImageViewHolder(v);

    }


    @Override
    public void onBindViewHolder(ViewMusicAdaptor.ImageViewHolder holder, final int position) {
    ...
    public void setOnItemClickListener(ViewMusicAdaptor.OnItemClickListener listener)
    {
