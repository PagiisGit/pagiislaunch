...
public class NotificationsAdapter extends RecyclerView.Adapter<NotificationsAdapter.ImageViewHolder> {
    ...
    public NotificationsAdapter(Context context, List<ImageUploads> uploads) {
        mContext = context;
        mUploads = uploads;
    }
    ...
    public NotificationsAdapter.ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.notification_view_layout, parent, false);
        return new NotificationsAdapter.ImageViewHolder(v);

    }

    @Override

    public void onBindViewHolder(NotificationsAdapter.ImageViewHolder holder, final int position) {
