...
public class mapsProfileItemsViewAdaptor extends RecyclerView.Adapter<mapsProfileItemsViewAdaptor.ImageViewHolder>{
    ...
    public mapsProfileItemsViewAdaptor(Context context, List<ImageUploads> uploads)
    {
        mContext = context;
        mUploads = uploads;
    ...
    public ImageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.maps_search_item_two, parent, false);
        return new mapsProfileItemsViewAdaptor.ImageViewHolder(v);
