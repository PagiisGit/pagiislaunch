...
public class PromoVideoViewAdapator  extends RecyclerView.Adapter<PromoVideoViewAdapator.VideoViewHolder> {
    ...
    private VideoViewAdapter.OnItemClickListener mListener;

    private ProgressBar mProgressBar;

    public PromoVideoViewAdapator(Context context, List<ImageUploads> uploads)
    {
        mContext = context;
        mUploads = uploads;
    }
    @Override
    public PromoVideoViewAdapator.VideoViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        View v = LayoutInflater.from(mContext).inflate(R.layout.video_view_item_two, parent, false);
        return new PromoVideoViewAdapator.VideoViewHolder(v);
    }
    @Override
    public void onBindViewHolder(final PromoVideoViewAdapator.VideoViewHolder holder, final int position)
    {
    ...
    public void setOnItemClickListener(VideoViewAdapter.OnItemClickListener listener)
    {
    ...
    public class VideoViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, MenuItem.OnMenuItemClickListener,View.OnCreateContextMenuListener{
        ...
        public void onCreateContextMenu(ContextMenu contextMenu, View view, ContextMenu.ContextMenuInfo contextMenuInfo) {
            ...
            MenuItem doWhatever = contextMenu.add(Menu.NONE, 1, 1, "Visit Sirocco");
