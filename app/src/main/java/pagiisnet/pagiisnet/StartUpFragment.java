 ...
 */
public class StartUpFragment extends Fragment implements ViewStoreCatergoryAdaptor.OnItemClickListener, MapsProfileAdapter.OnItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        businessReplacement = rootView.findViewById(R.id.businessId);
