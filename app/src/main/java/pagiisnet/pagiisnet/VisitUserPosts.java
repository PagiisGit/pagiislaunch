...
import pagiisnet.pagiisnet.Utils.ViewItemList;

public class VisitUserPosts extends AppCompatActivity implements  ViewItemList.OnItemClickListener
{

    private RecyclerView mRecyclerView;
    private ViewItemList mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_visit_user_posts);
        ...
        {
            mAuth.signOut();
            Intent intent = new Intent(VisitUserPosts.this,LoginActivity.class);
        ...
        mAdapter = new ViewItemList(VisitUserPosts.this, mUploads);

        mAdapter.setOnItemClickListener(VisitUserPosts.this);
        ...
        contentRater.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                if(tagedImages.isEmpty())
                {
                    ...
                    Toast.makeText(VisitUserPosts.this, "Refreshing...", Toast.LENGTH_SHORT).show();
                    updateArrayList();
                }
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                if(dataSnapshot.exists())
                {
                    ...
                    for(DataSnapshot ds : dataSnapshot.getChildren())
                    {
                        ...
                        {
                            Intent catchup = new Intent(VisitUserPosts.this, CatchUp.class);
                            startActivity(catchup);
                        }
                    }
                }else
                {
                    Toast.makeText(VisitUserPosts.this, "Tags not found.", Toast.LENGTH_SHORT).show();
                }
...

    {
        ...
        mDatabaseRef_x.child(currentUserId).limitToLast(10).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                if(dataSnapshot.exists())
                {
                    for(DataSnapshot ds : dataSnapshot.getChildren())
                    {
                        ...
                        }else
                        {
                            ...
                            Toast.makeText(VisitUserPosts.this, "Online posts currently unavailable.", Toast.LENGTH_SHORT).show();
                            finish();
                        }
                    }
                ...
                {
                    Toast.makeText(VisitUserPosts.this, "Pagiis online users currently unavailable.", Toast.LENGTH_SHORT).show();
            ...
            for (int i = 0; i < tagedUsers.size(); i++)
            {
                ...
                mDatabaseRef.child(taged_id).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onCancelled(DatabaseError databaseError) {
                        Toast.makeText(VisitUserPosts.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                        mProgressCircle.setVisibility(View.INVISIBLE);
                    }
                });
            }
        ...
        if(!getKey.isEmpty()) {
            ...
            mDatabaseRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    {
                        Toast.makeText(VisitUserPosts.this, "Pagiis failed to read database. please retry action", Toast.LENGTH_SHORT).show();
                        finish();
                    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            Intent intent = new Intent(VisitUserPosts.this, SiroccoPage.class);
            startActivity(intent);
        }
    ...
    public void onClick(int position)
    {
        ...
        if(!imageUrl.isEmpty() && !selectedKey.isEmpty())
        {
            ...
            Intent intent = new Intent(VisitUserPosts.this ,PagiisMaxView.class);
    ...
    public void onWhatEverClick(int position)
    {
        ...
        {
            Intent intent = new Intent(VisitUserPosts.this,UserProfileActivity.class);
    ...
    public void shareClick(int position)
    {
        ...
        if(!getUserRef.isEmpty() && !selectedKey.isEmpty())
        {
            Intent intent = new Intent(VisitUserPosts.this,ActivityUploadImage.class);
    ...
    public void chatsClick(int position)
    {
        ...
        final AlertDialog.Builder mBuilder = new AlertDialog.Builder(VisitUserPosts.this);
