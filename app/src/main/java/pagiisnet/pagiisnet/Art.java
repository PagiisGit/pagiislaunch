...
public class Art extends AppCompatActivity implements ViewStoreCatergoryAdaptor.OnItemClickListener,MapsProfileAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            mAuth.signOut();
            Intent intent = new Intent(Art.this, LoginActivity.class);
        ...
        actionBar.setTitle("@sir_occo #Art");
        ...
        mAdapter = new ViewStoreCatergoryAdaptor(Art.this,mUploads);

        mapsAdapter = new MapsProfileAdapter(Art.this,mapsUploads);


        mAdapter.setOnItemClickListener(Art.this);

        mapsAdapter.setOnItemClickListener(Art.this);
        ...
        gotoMusic.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent = new Intent(Art.this, SiroccoMusicActivity.class);
                startActivity(intent);
                finish();
    ...
    private void getOnlineHeadline()
    {
        ...
        mDataBaseListener = mDatabaseRef.orderByChild("exRating").equalTo("Art").addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(Art.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                mProgressCircle.setVisibility(View.INVISIBLE);
            }
        });
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        if (requestCode == MY_PERMISSIONS_REQUEST_READ_EXTERNAL_STORAGE) {
            if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(Art.this, "GET_ACCOUNTS Denied",
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {
            Intent intent = new Intent(Art.this, ActivityUploadImage.class);
    ...
    public void onItemClick(int position) {
        ...
        if (!imageUrl.isEmpty()) {
            ...
            {
                Intent intent = new Intent(Art.this, LinkView.class);
