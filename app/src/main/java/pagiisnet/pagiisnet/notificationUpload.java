...
public class notificationUpload {
    ...
    public notificationUpload(String name, String imageUrl, String rateEx, String userId,String views,String likes, String share,String postTime,String postLocation,String postName) {
