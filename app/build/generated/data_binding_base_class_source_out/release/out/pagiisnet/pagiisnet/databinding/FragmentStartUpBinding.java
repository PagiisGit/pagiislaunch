...
public final class FragmentStartUpBinding implements ViewBinding {
  ...
  private FragmentStartUpBinding(@NonNull FrameLayout rootView, @NonNull ImageView businessId,
  ...
  public static FragmentStartUpBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_start_up, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  public static FragmentStartUpBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentStartUpBinding((FrameLayout) rootView, businessId, goToMusic,
