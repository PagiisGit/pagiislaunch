...
public final class RequestItemBinding implements ViewBinding {
  ...
  private RequestItemBinding(@NonNull RelativeLayout rootView,
      @NonNull AppBarLayoutBinding chatbarLayout, @NonNull ImageView closeVideoPlay,
      @NonNull VideoView memeImageViewVideo, @NonNull RecyclerView memeRecyclerView,
      @NonNull ProgressBar progressCircle, @NonNull CardView videoViewCard,
  ...
  public static RequestItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RequestItemBinding((RelativeLayout) rootView, binding_chatbarLayout,
          closeVideoPlay, memeImageViewVideo, memeRecyclerView, progressCircle, videoViewCard,
          videotitle);
    }
