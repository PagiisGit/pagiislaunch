...
public final class ItemViewersItemviewBinding implements ViewBinding {
  @NonNull
  ...
  private ItemViewersItemviewBinding(@NonNull RelativeLayout rootView,
      ...
      @NonNull ImageView pagiisRadiusFriends, @NonNull TextView searchedItemDescription,
  ...
  @NonNull
  public static ItemViewersItemviewBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ItemViewersItemviewBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_viewers_itemview, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemViewersItemviewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemViewersItemviewBinding((RelativeLayout) rootView, TitleId, itemViewProfilepic,
          likesOne, likesTwo, pagiisRadiusChat, pagiisRadiusFriends, searchedItemDescription,
          siroccoBrandModel, siroccoImageView, views);
    }
