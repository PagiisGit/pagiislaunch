...
public final class ActivityBusinessBinding implements ViewBinding {
  ...
  private ActivityBusinessBinding(@NonNull RelativeLayout rootView, @NonNull ImageView businessId,
  ...
  public static ActivityBusinessBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityBusinessBinding((RelativeLayout) rootView, businessId,
          binding_chatbarLayout, goToMusic, progressCircle, siroccoRecyclerView,
          siroccoRecyclerViewTop);
    }
