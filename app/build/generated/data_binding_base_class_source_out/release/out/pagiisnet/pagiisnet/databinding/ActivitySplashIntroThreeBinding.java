...
public final class ActivitySplashIntroThreeBinding implements ViewBinding {
  @NonNull
  ...
  private ActivitySplashIntroThreeBinding(@NonNull RelativeLayout rootView, @NonNull TextView chats,
  ...
  @NonNull
  public static ActivitySplashIntroThreeBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivitySplashIntroThreeBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_splash_intro_three, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivitySplashIntroThreeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySplashIntroThreeBinding((RelativeLayout) rootView, chats, pagiisRadiusChat,
