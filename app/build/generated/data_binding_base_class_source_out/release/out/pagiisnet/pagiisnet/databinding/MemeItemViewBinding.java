...
public final class MemeItemViewBinding implements ViewBinding {
  @NonNull
  ...
  private MemeItemViewBinding(@NonNull CardView rootView, @NonNull LinearLayout TitleId,
      @NonNull TextView chats, @NonNull ImageView likes, @NonNull TextView likesText,
      @NonNull ImageView memeImageView, @NonNull RichLinkView memeImageViewLink,
      ...
      @NonNull TextView postTime, @NonNull TextView share,
  ...
  @NonNull
  public static MemeItemViewBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static MemeItemViewBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.meme_item_view, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static MemeItemViewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MemeItemViewBinding((CardView) rootView, TitleId, chats, likes, likesText,
          memeImageView, memeImageViewLink, memeName, pagiisRadiusChat, pagiisRadiusFriends,
          postPosition, postTime, share, userItemViewProfilepic, viewers, views);
    }
