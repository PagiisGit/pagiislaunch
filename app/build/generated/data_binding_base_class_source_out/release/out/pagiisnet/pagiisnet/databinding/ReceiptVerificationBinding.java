...
public final class ReceiptVerificationBinding implements ViewBinding {
  @NonNull
  ...
  private ReceiptVerificationBinding(@NonNull CardView rootView, @NonNull ImageView homeButotn,
  ...
  @NonNull
  public static ReceiptVerificationBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ReceiptVerificationBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.receipt_verification, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ReceiptVerificationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ReceiptVerificationBinding((CardView) rootView, homeButotn,
          selectChoseOptionLayout, verifyPurchase);
    }
