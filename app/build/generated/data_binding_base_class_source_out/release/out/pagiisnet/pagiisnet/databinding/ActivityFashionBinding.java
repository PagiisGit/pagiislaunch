...
public final class ActivityFashionBinding implements ViewBinding {
  ...
  private ActivityFashionBinding(@NonNull RelativeLayout rootView,
      @NonNull AppBarLayoutBinding chatbarLayout, @NonNull ImageView fashionId,
  ...
  public static ActivityFashionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityFashionBinding((RelativeLayout) rootView, binding_chatbarLayout, fashionId,
