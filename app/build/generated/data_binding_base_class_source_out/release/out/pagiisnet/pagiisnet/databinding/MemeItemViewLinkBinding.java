...
public final class MemeItemViewLinkBinding implements ViewBinding {
  @NonNull
  ...
  private MemeItemViewLinkBinding(@NonNull CardView rootView, @NonNull LinearLayout TitleId,
      ...
      @NonNull TextView postPosition, @NonNull TextView postTime, @NonNull TextView share,
      @NonNull ImageView userItemViewProfilepic, @NonNull TextView viewers,
  ...
  @NonNull
  public static MemeItemViewLinkBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static MemeItemViewLinkBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.meme_item_view_link, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static MemeItemViewLinkBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new MemeItemViewLinkBinding((CardView) rootView, TitleId, chats, likes, likesText,
          memeImageView, memeName, pagiisRadiusChat, pagiisRadiusFriends, postPosition, postTime,
          share, userItemViewProfilepic, viewers, views);
    }
