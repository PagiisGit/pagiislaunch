...
public final class FragmentArtBinding implements ViewBinding {
  ...
  private FragmentArtBinding(@NonNull FrameLayout rootView, @NonNull ImageView canvasId,
      @NonNull AppBarLayoutBinding chatbarLayout, @NonNull ProgressBar progressCircle,
  ...
  @NonNull
  public static FragmentArtBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentArtBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_art, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentArtBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentArtBinding((FrameLayout) rootView, canvasId, binding_chatbarLayout,
