...
public final class ActivityViewMyCartBinding implements ViewBinding {
  @NonNull
  private final RelativeLayout rootView;

  @NonNull
  public final ImageView cartId;
  ...
  private ActivityViewMyCartBinding(@NonNull RelativeLayout rootView, @NonNull ImageView cartId,
      @NonNull AppBarLayoutBinding chatbarLayout, @NonNull FloatingActionButton goToVideos,
  ...
  @NonNull
  public static ActivityViewMyCartBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityViewMyCartBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_view_my_cart, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityViewMyCartBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.cartId;
      ImageView cartId = ViewBindings.findChildViewById(rootView, id);
      if (cartId == null) {
        break missingId;
      }
      ...
      return new ActivityViewMyCartBinding((RelativeLayout) rootView, cartId, binding_chatbarLayout,
          goToVideos, memeRecyclerView, progressCircle);
    }
