...
public final class ActivityVisitUserPostsBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final ImageView logSearchIcon;
  ...
  private ActivityVisitUserPostsBinding(@NonNull RelativeLayout rootView,
      @NonNull AppBarLayoutBinding chatbarLayout, @NonNull FloatingActionButton contentRating,
      @NonNull ImageView logSearchIcon, @NonNull RecyclerView memeRecyclerView,
  ...
  @NonNull
  public static ActivityVisitUserPostsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityVisitUserPostsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_visit_user_posts, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityVisitUserPostsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ImageView logSearchIcon = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityVisitUserPostsBinding((RelativeLayout) rootView, binding_chatbarLayout,
          contentRating, logSearchIcon, memeRecyclerView, progressCircleUserMemes);
    }
