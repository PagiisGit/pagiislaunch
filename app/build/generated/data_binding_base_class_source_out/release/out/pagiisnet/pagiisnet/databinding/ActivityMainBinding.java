...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull RelativeLayout rootView, @NonNull LinearLayout canvasId,
      @NonNull ImageView cc, @NonNull AppBarLayoutBinding chatbarLayout,
      @NonNull FloatingActionButton goToMusic, @NonNull ImageView ii,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((RelativeLayout) rootView, canvasId, cc, binding_chatbarLayout,
          goToMusic, ii, progressCircle, siroccoRecyclerView);
    }
