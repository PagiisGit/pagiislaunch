...
public final class NotificationViewLayoutBinding implements ViewBinding {
  @NonNull
  ...
  private NotificationViewLayoutBinding(@NonNull RelativeLayout rootView,
      @NonNull RelativeLayout TitleId, @NonNull CircularImageView itemViewProfilepic,
      @NonNull TextView likesOne, @NonNull TextView likesTwo,
      @NonNull ProgressBar progressCircleUserMemes, @NonNull RelativeLayout relativeSearcLayout,
  ...
  @NonNull
  public static NotificationViewLayoutBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static NotificationViewLayoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.notification_view_layout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static NotificationViewLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new NotificationViewLayoutBinding((RelativeLayout) rootView, TitleId,
          itemViewProfilepic, likesOne, likesTwo, progressCircleUserMemes, relativeSearcLayout,
          searchedItemDescription, siroccoBrandModel, siroccoImageView, viewImageItemCard);
    }
